...
const Work = () => {
  return (
    <div id='work' className='w-full px-[12%] py-10 scroll-mt-20'>
      ...
      <h2 className='text-center text-5xl'>Meus últimos trabalhos</h2>
      <p className='text-center max-w-2xl mx-auto mt-5 mb-12'>Bem-vinda(o) ao meu portfólio de desenvolvimento web. Aqui você encontra uma seleção de projetos que representam minha evolução no frontend, design e experiência do usuário.</p>
      ...
      <div className='grid grid-cols-auto my-10 gap-5'>
        ...
        <a href="" className='w-max flex items-center justify-center gap-2 text-gray-700 border-[0.5px] border-gray-700 rounded-full py-3 px-10 mx-auto my-20 hover:bg-lightHover duration-500'>
            Mostre mais <Image src={assets.right_arrow_bold} alt='right arrow' className='w-4'/>
        </a>
      </div>
  )
}
